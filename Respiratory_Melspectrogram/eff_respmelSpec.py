...
def train_model(model):
    ...
    f = open("resp_eff_melspec.txt","w+")
    f.write("Respiratory Efficientnet MelSpec \n")
    f.close()
...
def test_model(test_ds, model):
    ...
    print("BALANCED acuracy -> ", balanced_accuracy_score(y_true, y_pred))
